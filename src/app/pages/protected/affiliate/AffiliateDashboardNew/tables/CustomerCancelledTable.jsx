...
export default function CustomerCancelledTable(props) {
    ...
    const color = {
        ...
        "subscription_paused": "#FF7A00",  // Red for cancelled
    };
    ...
    //         setCurrentUsers(() => customer_cancelled.slice(indexOfFirstUser, indexOfLastUser));
    //     } else {
    //         setCurrentUsers([]);
    //     }
    // }, [currentPage, customer_cancelled, itemsPerPage, indexOfFirstUser, indexOfLastUser]);
                    ...
                    <Table className='sep-AffiliateTable-main' aria-label="customer table">
                        <TableHead>
                            <TableRow sx={{ backgroundColor: '#f4f6f8' }}>
                                ...
                                <TableCell align="center"><Typography variant="subtitle2">Cancellation on</Typography></TableCell>
                                {/* <TableCell align="center"><Typography variant="subtitle2">Sponsor By</Typography></TableCell> */}

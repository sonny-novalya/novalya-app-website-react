...
const TargetedPromotion = () => {
    const actions = [
        { action: "Import Facebook groups", completed: false, videoUrl: "https://www.youtube.com/watch?v=abc123" },
        { action: "Add one person to CRM", completed: false, videoUrl: "https://www.youtube.com/watch?v=xyz789" },
        { action: "Add one person to CRM", completed: false, videoUrl: "https://www.youtube.com/watch?v=def456" },
    ]

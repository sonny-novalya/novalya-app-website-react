    ...
    return (
        ...
        >
            <div className="flex justify-between items-center mb-4">
                <div>
                    <div className="text-lg font-semibold flex items-center space-x-2">
                        <h2>{t("crm.Note For")}{" "} {userInfo.firstName} {userInfo.lastName}</h2>
                        <span className="text-sm text-gray-500">(stage 1)</span>
                        <span className="text-xs text-[#EB8D06] border border-[#F9DFB9] bg-[#fDF5E8] px-2 py-1 rounded-full">{t("crm.Low Priority")}</span>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    <label className="block text-sm font-medium mb-1">{t("crm.First name")}</label>
                    <input
                        name="firstName"
                ...
                <div>
                    <label className="block text-sm font-medium mb-1">{t("crm.Last name")}</label>
                    <input
                        name="lastName"
            ...
            <div className="mt-4">
                <label className="block text-sm font-medium mb-1">
                    {t("crm.Group tags")}{" "} <span className="text-gray-400">(i)</span>
                </label>
                ...
                <Select
                    ...
                    placeholder={t("crm.Select group tags")}
                    tagRender={(props) => {
            ...
            <div className="mt-4">
                <label className="block text-sm font-medium mb-1">
                    {t("crm.Phone")}{" "} <span className="text-gray-400">(i)</span>
                </label>
                <input
                    name="phone"
                    type="text"
                    ...
                    onChange={handleChange}
                    placeholder={t("crm.Enter phone number")}
                    className="w-full border border-gray-300 rounded px-3 py-2"
                />
            </div>
            ...
            <div className="mt-4">
                <label className="block text-sm font-medium mb-1">
                    {t("crm.Email")}{" "} <span className="text-gray-400">(i)</span>
                </label>
                <input
                    name="email"
                    type="email"
            ...
            <div className="mt-4">
                <label className="block text-sm font-medium mb-1">
                    {t("crm.Write note")}{" "} <span className="text-gray-400">(i)</span>
                </label>
                <textarea
                    rows={4}
                    value={userInfo.note}
                    onChange={handleNoteChange}
                    placeholder={t("crm.Write your note")}
                    className="w-full border border-gray-300 rounded px-3 py-2"
                />
            </div>

    ...
    return (
        ...
        >
            <div className="bg-gray-50 rounded-t-lg border-b-[#DADADA] border-b pb-4 ">
                <h2 className="text-xl font-medium ">Send a campaign to 15 people</h2>
            </div>
            <h2 className="text-lg font-medium mt-3">Select the time interval</h2>
            ...
            <h2 className="text-lg font-medium my-3">Select a message</h2>
            <Select
            ...
            <h2 className="text-lg font-medium my-3">Select the next action</h2>
            <Select
                className="w-full rounded-lg bg-white border border-gray-300 px-4 text-gray-800 text-base focus:outline-none focus:ring-2 focus:ring-blue-400"
                placeholder="Select Message"
                value={selectedMessage || undefined}

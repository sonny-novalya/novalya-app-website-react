        ...
        <div className="w-full h-full bg-white rounded-lg flex flex-col">
            ...
            <div className="flex-1 overflow-auto my-5 ctm-list-design">
                {filteredMessages?.map((record) => (
                    <div
                        key={record?.id}
                        className={`cursor-pointer flex w-full items-center justify-between px-4 py-3 border bg-[#F5F5F5] rounded-[8px] my-2 ${selectedRow == record?.id ? "bg-blue-100 rounded-xl border-[#0087FF]" : "border-white hover:border-gray-200"}`}
                    ...
                    >
                        ...
                        <div>
                            <div className="flex justify-end items-center gap-2">
                                <button className="flex items-center h-9 min-w-[86px] px-[12px] py-[8px] gap-[4px] bg-white rounded-[25px] border-transparent text-[#808183] text-[14px] leading-[21px] tracking-normal font-medium cursor-pointer btn-hover" onClick={(e) => {
                                    e.stopPropagation();
                                    handleEdit(record);
                                }}>
                                    {/* <span><EditIcon /></span> */}

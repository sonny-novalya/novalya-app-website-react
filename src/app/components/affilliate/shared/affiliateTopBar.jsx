...
const AfiliateTopBar = () => {
  ...
  return (
    ...
    <div className="flex justify-between gap-6 affiliate-btn-wrap">
      ...
      <Button className={`${location.pathname === "/affiliate/settings"?"affiliate-btn-Active": "affiliate-btn" }  w-full min-h-12 sm:w-1/4 border-gray-300 font-[500] text-[16px] sm:text-[18px] leading-[25.2px] !text-[16px] sm:!text-[18px] !p-3`} onClick={()=>navigate('/affiliate/settings')}>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" clipRule="evenodd" d="M12 15C10.3431 15 9 13.6569 9 12C9 10.3431 10.3431 9 12 9C13.6569 9 15 10.3431 15 12C15 13.6569 13.6569 15 12 15Z" stroke="#797979" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>

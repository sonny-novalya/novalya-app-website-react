...
const CreateMessage = () => {
  ...
  return (
    ...
    <div className="bg-white px-5 py-4 rounded-[10px] max-w-[1135px] mx-auto w-full relative max-h-[90vh] overflow-auto">
        <div className="flex items-center gap-[10px] text-[20px]">Message name
        ...
        <div className="flex gap-4 mt-4">
            <div className="w-[200px] bg-[#F5F5F5] rounded p-3">
                <div className="flex items-center gap-[10px] text-[20px]">Your variants
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-[685px] px-3 py-1">
                <div className="flex items-center justify-between gap-[10px] mb-1">
                    <div className="flex items-center gap-[10px] text-[20px]">Write message
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7.0026 13.1668C10.4084 13.1668 13.1693 10.4059 13.1693 7.00016C13.1693 3.59441 10.4084 0.833496 7.0026 0.833496C3.59685 0.833496 0.835938 3.59441 0.835938 7.00016C0.835938 10.4059 3.59685 13.1668 7.0026 13.1668Z" stroke="black" stroke-opacity="0.75" stroke-width="0.9"></path>
                            <path d="M7 6.87549V10.2088" stroke="black" stroke-opacity="0.75" stroke-linecap="round"></path>
                            <path d="M7.00521 5.45866C7.46545 5.45866 7.83854 5.08556 7.83854 4.62533C7.83854 4.16509 7.46545 3.79199 7.00521 3.79199C6.54497 3.79199 6.17188 4.16509 6.17188 4.62533C6.17188 5.08556 6.54497 5.45866 7.00521 5.45866Z" fill="black" fill-opacity="0.75"></path>
                ...
                <div className="border border-[#E6E6E6] h-[93.75%] p-3">
                    ...
                    <div className="flex items-center gap-[10px] justify-between">
                        <div className="flex items-center gap-[10px]">
                            ...
                            <button className="varient-btn-hover bg-white border border-[#0087FF] text-[14px] text-[#0087FF] px-4 py-2 rounded-md hover:bg-[#0087FF] hover:text-white min-h-[36px]">
                            Last name</button>
                            <button className="varient-btn-hover flex items-center gap-2 bg-white border border-[#0087FF] text-[14px] text-[#0087FF] px-4 py-1 rounded-md hover:bg-[#0087FF] hover:text-white min-h-[36px]">
                                <svg width="31" height="32" viewBox="0 0 31 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M15.4974 18.5832C12.2682 18.5832 11.2995 17.2915 10.3307 17.2915C9.62031 17.2915 9.03906 17.8728 9.03906 18.5832C9.03906 19.5519 10.9766 23.7498 15.4974 23.7498C20.0182 23.7498 21.9557 19.5519 21.9557 18.5832C21.9557 17.8728 21.3745 17.2915 20.6641 17.2915C19.6953 17.2915 18.7266 18.5832 15.4974 18.5832Z" fill="#0087FF"/>
                                    <path d="M15.5 4.375C21.9196 4.375 27.125 9.58042 27.125 16C27.125 22.4196 21.9196 27.625 15.5 27.625C9.08042 27.625 3.875 22.4196 3.875 16C3.875 9.58042 9.08042 4.375 15.5 4.375Z" stroke="#0087FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M11.625 12.125V13.4167" stroke="#0087FF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M19.375 12.125V13.4167" stroke="#0087FF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                                Emoji
                            </button>
                            <button className="varient-btn-hover flex items-center gap-2 bg-white border border-[#0087FF] text-[14px] text-[#0087FF] px-4 py-2 rounded-md hover:bg-[#0087FF] hover:text-white min-h-[36px]">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M19.25 11V6.5C19.25 5.17392 18.7232 3.90215 17.7855 2.96447C16.8479 2.02678 15.5761 1.5 14.25 1.5H5.75C4.42392 1.5 3.15215 2.02678 2.21447 2.96447C1.27678 3.90215 0.75 5.17392 0.75 6.5V13.5C0.75 14.1566 0.879329 14.8068 1.1306 15.4134C1.38188 16.02 1.75017 16.5712 2.21447 17.0355C3.15215 17.9732 4.42392 18.5 5.75 18.5H12.01" stroke="#0087FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M1.00781 15.0001L3.74781 11.8001C4.10765 11.4427 4.57992 11.2206 5.08469 11.1714C5.58946 11.1222 6.09573 11.249 6.51781 11.5301C6.9399 11.8113 7.44616 11.938 7.95093 11.8888C8.4557 11.8396 8.92797 11.6175 9.28781 11.2601L11.6178 8.93013C12.2873 8.25836 13.1737 7.84633 14.1188 7.76757C15.064 7.68881 16.0064 7.94844 16.7778 8.50013L19.2478 10.4101M6.00781 8.17013C6.22581 8.16881 6.44141 8.12458 6.64231 8.03994C6.8432 7.9553 7.02546 7.83193 7.17868 7.67685C7.3319 7.52178 7.45307 7.33805 7.53528 7.13614C7.61749 6.93424 7.65913 6.71812 7.65781 6.50013C7.6565 6.28213 7.61226 6.06653 7.52763 5.86563C7.44299 5.66474 7.31961 5.48248 7.16454 5.32926C7.00946 5.17604 6.82573 5.05487 6.62383 4.97266C6.42192 4.89045 6.20581 4.84881 5.98781 4.85013C5.54755 4.85278 5.12638 5.03022 4.81694 5.3434C4.50751 5.65659 4.33516 6.07987 4.33781 6.52013C4.34046 6.96039 4.5179 7.38156 4.83109 7.691C5.14427 8.00043 5.56755 8.17278 6.00781 8.17013Z" stroke="#0087FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M16.7031 13V18" stroke="#0087FF" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
                                    <path d="M19.0001 15.1049L17.0331 13.1379C16.9903 13.095 16.9395 13.0609 16.8836 13.0377C16.8276 13.0144 16.7676 13.0024 16.7071 13.0024C16.6465 13.0024 16.5865 13.0144 16.5306 13.0377C16.4746 13.0609 16.4238 13.095 16.3811 13.1379L14.4141 15.1049" stroke="#0087FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                                Upload image
                            </button>
                        </div>
                        <span className="font-medium text-[14px] leading-[21px] tracking-[0%] text-[#00000080] px-4">114/2000</span>
                    </div>
                </div>
            </div>
            <div className="w-[200px] bg-[#F5F5F5] rounded p-3 ">
                <div className="flex items-center gap-[10px] text-[20px] mb-3">Write with AI
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7.0026 13.1668C10.4084 13.1668 13.1693 10.4059 13.1693 7.00016C13.1693 3.59441 10.4084 0.833496 7.0026 0.833496C3.59685 0.833496 0.835938 3.59441 0.835938 7.00016C0.835938 10.4059 3.59685 13.1668 7.0026 13.1668Z" stroke="black" stroke-opacity="0.75" stroke-width="0.9"></path>
                        <path d="M7 6.87549V10.2088" stroke="black" stroke-opacity="0.75" stroke-linecap="round"></path>
                        <path d="M7.00521 5.45866C7.46545 5.45866 7.83854 5.08556 7.83854 4.62533C7.83854 4.16509 7.46545 3.79199 7.00521 3.79199C6.54497 3.79199 6.17188 4.16509 6.17188 4.62533C6.17188 5.08556 6.54497 5.45866 7.00521 5.45866Z" fill="black" fill-opacity="0.75"></path>
                ...
                <p className="font-normal text-[14px] leading-[21px] uppercase my-[10px]">Adjust Tone</p>
                <button className="varient-btn-hover text-[14px] bg-white border border-[#0087FF42] flex items-center justify-center gap-[10px] w-full px-3 py-2 rounded-md mb-[6px] hover:bg-[#0087FF] hover:text-white">
        ...
        <div className="flex gap-4 justify-between mt-6">
            <button onClick={()=>setStep(5)} className="flex justify-center gap-2 font-regular text-[21px] text-[white] leading-[36px] bg-[#0087FF] px-4 py-1.5 w-full max-w-[200px] rounded-md">Preview</button>
            <div className="flex gap-4">
                <button className="font-regular text-[21px] leading-[36px] bg-[#E8E8E8] 
                 px-4 py-1.5 w-[200px] rounded-md flex justify-center" onClick={()=>setIsMessage(false)}>Cancel
                </button>
                <button className="flex items-center justify-center gap-2 font-regular text-[21px] text-[white] leading-[36px] bg-[#0087FF] px-4 py-1.5 w-[200px] rounded-md">Create 

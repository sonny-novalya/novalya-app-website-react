          ...
          <div className='message-popup-content flex flex-col max-h-[85vh]'>
            ...
            <div className='message-popup-list flex-grow overflow-auto mx-5 pr-0.5 gray-scroll'>
              { loading ? <div className='flex justify-center items-center h-[300px]'>
                ...
                <button onClick={()=>handleEdit(message)} className='flex items-center gap-1.5 h-9 bg-white px-4.5 py-1.5 rounded-full font-semibold text-[#808080]'>
                ...
                <button className='flex items-center gap-1.5 h-9 bg-white px-4.5 py-1.5 rounded-full font-semibold text-[#808080]' onClick={()=> handlePreview(message)} >
